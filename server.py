...
APP_VERSION = 'v5-camera-profile-rec-photo-20260818'
...
<body>
<div class="app" data-build="v4-photo-responsive">
...
async function loadComments(){
  ...
  data.forEach(c=>box.innerHTML+=`<div class="comment"><div class="cav">${esc(c.username[0].toUpperCase())}</div><div class="ctext"><span class="cname">${esc(c.username)}</span>${esc(c.body)}</div></div>`);
}
